...
const ProfesoresManager = () => {
    ...
    const fetchProfesores = async () => {
        ...
        setLoading(true);
        try {
            console.log('Intentando conectar a:', buildApiUrl(API_CONFIG.PROFESORES.GET_ALL));
            const response = await fetch(buildApiUrl(API_CONFIG.PROFESORES.GET_ALL), {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            const response = await fetch(buildApiUrl(API_CONFIG.PROFESORES.CREATE), {
                method: 'POST',
                headers: getAuthHeaders(),
    ...
    const handleDelete = async (id) => {
        ...
        try {
            const response = await fetch(buildApiUrl(`${API_CONFIG.PROFESORES.DELETE}${id}`), {
                method: 'DELETE',
                headers: getAuthHeaders()
            });
    ...
    const handleEditSubmit = async (e) => {
        ...
        try {
            ...
            const response = await fetch(buildApiUrl(`${API_CONFIG.PROFESORES.UPDATE}${editingProfesor.id}`), {
                method: 'PUT',
                headers: getAuthHeaders(),
                body: JSON.stringify(formData)
            });
                        ...
                        {currentProfesores.map((profesor, index) => (
                            <div key={profesor.id || index} className="profesor-card">
                                ...
                                <div className="profesor-info">
                                    ...
                                    <p className="profesor-email">{profesor.correo}</p>
