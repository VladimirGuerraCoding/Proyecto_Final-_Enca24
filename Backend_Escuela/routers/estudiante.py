...
def create_estudiante(estudiante: Estudiante):
    try:
        ...
        new_estudiante = Estudiante(
            id=new_estudiante_data['id'],
            nombre=new_estudiante_data['nombre'],
            apellido=new_estudiante_data['apellido'],
            correo=new_estudiante_data['correo'],
            edad=new_estudiante_data['edad'],
            direccion=new_estudiante_data['direccion']
        )
...
def update_estudiante(id: int, estudiante: Estudiante):
    try:
        ...
        updated_estudiante = Estudiante(
            id=updated_estudiante_data['id'],
            nombre=updated_estudiante_data['nombre'],
            apellido=updated_estudiante_data['apellido'],
            correo=updated_estudiante_data['correo'],
            edad=updated_estudiante_data['edad'],
            direccion=updated_estudiante_data['direccion']
        )
